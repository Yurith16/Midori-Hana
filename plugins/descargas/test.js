...
// Verificar si existe el archivo local al cargar el plugin
if (fsSync.existsSync(ytDlpPath)) {
  console.log(`✅ [TESTMP3] Usando yt-dlp LOCAL en: ${ytDlpPath}`);
} else {
  console.log(`⚠️ [TESTMP3] No se encontró yt-dlp local en: ${ytDlpPath}`);
}
